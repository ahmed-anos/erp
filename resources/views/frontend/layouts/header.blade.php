  ...
  <header class="app-header">
    <ul class="app-nav" style="justify-content: start">
      ...
      <li class="dropdown"><a class="app-nav__item" href="#" data-bs-toggle="dropdown" aria-label="Open Profile Menu"><i class="bi bi-person fs-4"></i></a>
        <ul class="dropdown-menu settings-menu dropdown-menu-right">
          <li><a class="dropdown-item" href=""><i class="bi bi-gear me-2 fs-5"></i> الاعدادت</a></li>
          <li><a class="dropdown-item" href="{{ route('profile.edit') }}"><i class="bi bi-person me-2 fs-5"></i> الملف الشخصي</a></li>
          <li>
    ...
    <a class="app-header__logo" href="{{ route('dashboard') }}">شركه دانه العواصم</a>
    <!-- Navbar Right Menu-->
  </header>